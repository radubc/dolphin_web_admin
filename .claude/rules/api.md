...
- Key prefixes say what the key is: `ip:`, `user:`, `key:`, `login:ip:`, `login:email:`, `reset:ip:`, `reset:email:`, `account:password:`, `account:totp:` (per operator id), `passkey:email:`. Email keys are lowercased.
